...
Future work could involve exploring more advanced control strategies or adaptive PID tuning to enhance performance in complex driving scenarios. Additionally, varying the vehicle's speed, adding turns that are not 90 degrees, experimenting with different simulation environments, and integrating computer vision techniques could lead to a fully autonomous vehicle without the need for manual route planning.
